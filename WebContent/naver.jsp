...
<html lang="en">
  <head>
    ...
    <!-- full calendar css-->
    <link href="assets2/fullcalendar/fullcalendar/bootstrap-fullcalendar.css" rel="stylesheet" />
	<link href="assets2/fullcalendar/fullcalendar/fullcalendar.css" rel="stylesheet" />
    <!-- easy pie chart-->
    <link href="assets2/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" meGdia="screen"/>
    <!-- owl carousel -->
...
window.onload=function(){
  ...
  <section id="container" class="">
      ...
      <header class="header dark-bg">
            ...
            <!--logo start-->
            <a href="home.html" class="logo">Team<span class="lite"> SC</span></a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li id="task_notificatoin_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li class="external">
                                <a href="home.html">전체보기</a>
                            </li>
                            
                            
                            <li class="active">
                                <a href="DispatcherServlet?command=gmail">
                                    <div class="task-info">
                    ...
                    <li id="mail_notificatoin_bar" class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="badge bg-important">최근 메일 5개</span>
                        </a>
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo">다음, 지메일, 네이버 로고 만들어놓고 그 사진 넣어놓기<img alt="avatar" src="./img2/avatar-mini.jpg"></span>
                                    <span class="subject">
                                    <span class="from">보낸사람 주소</span>
                                    <span class="time">몇분전에 왔는지</span>
                                    </span>
                                    <span class="message">
                                        요약본 or 첨부파일G
                                    </span>
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">로그인한사람 id or 이름</span>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu extended logout">
                            <div class="log-arrow-up"></div>
                            <li class="eborder-top">
                                <a href="#"><i class="icon_profile"></i>설정하러가기</a>
                            </li>
                            <li>
                                <a href="#"><i class="icon_mail_alt"></i>모든메일 보여주는데로</a>
                            </li>
                            <li>
                                <a href="#"><i class="icon_clock_alt"></i>Naver</a>
                            </li>
                            <li>
                                <a href="#"><i class="icon_chat_alt"></i>Gmail</a>
                            </li>
                            <li>
                                <a href="#"><i class="icon_chat_alt"></i>Daum</a>
                            </li>
                            <li>
						...
						<li class="sub-menu">
						  <a href="javascript:;" class="">
		                      <!-- <a href="gmail.html" class=""> -->
		                          ...
		                          <span>Gmail</span>
		                          <span clss="menu-arrow arrow_carrot-right"></span>
		                  </a>
                      <ul class="sub">
                      <%-- <c:forEach></c:forEach> --%>
                          <li><a class="" href="DispatcherServlet?command=gmail">gmail</a></li>                          
                          <li><a class="" href="DispatcherServlet?command=home">naver</a></li>
                      </ul>
	                  </li>
...
-->                  
	...
	<thead>
		<tr>
		<td>메일번호</td><td>제목</td><td>보낸 사람</td><td>받은 시간</td>
		</tr>
	</thead>
	<tbody>
		<c:forEach items="${requestScope.naver}" var="allview">
			<tr>
				...
				<td align="center"><a href="DispatcherServlet?command=view&bno=${allview.mail_no}">${allview.title}</a></td>
	...
	<input type="button" border="0" value="홈으로" onclick="location.href='\index.jsp'">
      </section>
      <!--main content end-->
  </section>
  <!-- container section start -->
