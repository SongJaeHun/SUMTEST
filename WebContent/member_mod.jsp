...
<!-- 모달    모달    모달    모달    모달    모달    모달    모달    모달     -->
 ...
 <!-- 모달 끝       모달 끝       모달 끝       모달 끝       모달 끝       모달 끝       모달 끝       모달 끝        -->
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				...
				<li><i class="fa fa-laptop"></i>Member Mod</li>
			</ol>
		</div>
	</div>
	...
	<div style="padding-left:17px">
		<form name="memberForm" method="post" action="DispatcherServlet">
		<input type="hidden" name="command" value="memmod">
		  ...
		  <option value="${list.acc_id}">${list.acc_addr} </option>
			...
			<input type="button" value="수정" onClick="memberMod()">
		</form>
	</div>
